...
def install(app=None):
    ...
    try:
        ...
        if "AccessMatrix" in class_registry:
            del class_registry["AccessMatrix"]
            print("🧹 Removed old AccessMatrix ORM class from registry.")
        ...
        try:
            Base.metadata.create_all(bind=engine, tables=[AccessMatrix.__table__])
            print("✅ AccessMatrix table created (if not existing).")
        ...
        print("✅ AccessMatrix module installed successfully.")
